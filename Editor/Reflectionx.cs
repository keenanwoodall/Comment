...
{
    // original code from https://github.com/MechWarrior99/Bewildered-Core
    public static class Reflectionx
    {
        ...
        public static MethodInfo Method(Type type, string name, params Type[] parameters)
        {
            ...
            return FindMemberIncludingBaseTypes(type,
                t => t.GetMethod(name, All, null, parameters, new ParameterModifier[0]));
        }
